//
//  CustomExchangeDropdownButton.swift
//  Cryptix
//
...
class CustomExchangeDropdownButton: UITextField {
    private var pickerView = UIPickerView()
    var homeViewModel: HomeViewModel
    
    var options: ExhangeList = [] {
        didSet {
...
extension CustomExchangeDropdownButton: UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        homeViewModel.exchange = selectedOption
    }
}
